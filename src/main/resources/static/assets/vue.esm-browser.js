...
function parseComment(context) {
    ...
    if (!match) {
        ...
        // Advancing with reporting nested note.
    ...
    if (dir.name === 'if') {
        ...
        while (i-- >= -1) {
            ...
            if (sibling && sibling.type === 9 /* IF */) {
                ...
                const branch = createIfBranch(node, dir);
                if ( note.length) {
                    branch.children = [...note, ...branch.children];
                }
...
function renderComponentRoot(instance) {
    ...
    try {
        ...
        // attr merging
        // in dev mode, note are preserved, and it's possible for a template
        // to have note along side the root element which makes it a fragment
        let root = result;
...
function baseCreateRenderer(options, createHydrationFns) {
    ...
    const processCommentNode = (n1, n2, container, anchor) => {
        if (n1 == null) {
            ...
            // there's no support for dynamic note
            n2.el = n1.el;
        }
    };
